...
// const { createAccessToken, createRefreshToken } = require('../utility/utilities');
...
//             res.cookie('refreshToken', refreshToken, {maxAge: 60000*60, httpOnly: true, sameSite: 'strict'});
